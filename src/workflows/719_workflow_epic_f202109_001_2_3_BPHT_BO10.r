...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106,202105, 202104, 202103, 202102, 202101,202012, 202011, 202010, 202009, 202008, 202007,202002, 202001,201912, 201911,201909, 201908, 201907, 201906,201904, 201903)
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,202012, 202011, 202010, 202009, 202008, 202007,202002, 202001,201912, 201911,201909, 201908, 201907, 201906,201904, 201903, 201902, 201901)
...
HT_tuning_epic <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$train$repeticiones_exp <- 2
  ...
  param_local$lgb_param <- list(
    ...
    lambda_l1 = c(0.01,160), # lambda_l1 >= 0.0
    lambda_l2 = c(0.01,160), # lambda_l2 >= 0.0
...
FM_final_models_lightgbm_semillerio <- function( pinputexps, ranks, semillerio, repeticiones_exp)
{
  ...
  param_local$modelos_iteracion <- c(10)
...
KA_evaluate_kaggle_semillerio <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2602_KA_evaluate_kaggle_semillerio.r"
...
wf_septiembre <- function( pnombrewf )
{
  ...
  ht <- HT_tuning_epic(bypass=TRUE)

  fm <- FM_final_models_lightgbm_semillerio( c(ht, ts9), ranks=c(1), semillerio=20, repeticiones_exp=2 )
